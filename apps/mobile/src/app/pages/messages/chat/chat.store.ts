...
import {
  mobileAuthState,
  mobileMessagingState,
  SupabaseService,
} from '@skooltrak/store';
...
export class ChatStore extends ComponentStore<State> implements OnStoreInit {
  ...
  private auth = inject(mobileAuthState.MobileAuthFacade);
  private readonly store = inject(mobileMessagingState.MessagingStateFacade);
