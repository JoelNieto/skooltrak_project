...
@Component({
  ...
  template: `<div
    class="flex p-1 pr-2 items-center text-xs gap-2 border border-emerald-500 rounded-full font-sans font-semibold bg-emerald-100 text-emerald-700 dark:bg-emerald-700 dark:text-gray-200"
  >
    <sk-avatar
