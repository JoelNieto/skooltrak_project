...
@Component({
  ...
  template: `<section class="bg-gray-50 dark:bg-gray-900 font-sans">
    <div
    ...
    >
      ...
      <div
        class="w-full bg-white rounded-xl p-6 space-y-4 md:space-y-6 sm:p-8 shadow-xl dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700"
      >
        <h1
        ...
        <form class="space-y-4 md:space-y-6" action="#">
          ...
          <div>
            <label class="block mb-2 font-sans">Password</label>
            <input
              class="input"
              type="password"
              name="password"
