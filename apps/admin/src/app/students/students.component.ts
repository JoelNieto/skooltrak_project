...
@Component({
  ...
  template: `<h2
      class=" sticky top-0 bg-white dark:bg-gray-800 pb-3 leading-tight tracking-tight flex text-gray-700 dark:text-white text-2xl font-mono font-bold mb-1"
    >
      Students
    </h2>
    <div
    ...
    >
      <ul class="flex flex-wrap -mb-px">
        <li class="mr-2">
          <a routerLink="all" routerLinkActive="active" class="link">Active</a>
        </li>
        <li class="mr-2">
